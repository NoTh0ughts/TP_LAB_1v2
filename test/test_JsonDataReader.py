...
class TestJsonDataReader:
    ...
    def file_and_data_content(self) -> tuple[str, DataType]:
        text = '{  "Иванов Иван Иванович" :  [    {"математика":80},   ' \
               ' {"программирование": 90},    {"литература": ' \
               '76}  ],  "Петров Петр Петрович" :  ' \
               '[    {"математика": 100},  ' \
               '  {"программирование": 90},    ' \
               '{"литература":61}  ]} '
    ...
    def incorrect_data(self) -> str:
        return '"Иванов Иван Иванович": "литература": 97,' \
               '"математика": 99, "программирование": 98}, "Петров Петр ' \
               'Петрович": {"литература": 12, ' \
               '"математика": 10, "программирование": 11}} '
